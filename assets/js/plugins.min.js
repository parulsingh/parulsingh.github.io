 ...
 * GitHub  : https://github.com/nk-o/jarallax
 */
function(){"use strict";if("undefined"!=typeof jarallax){var t=jarallax.constructor,e=t.prototype.init;t.prototype.init=function(){var t=this;e.apply(t),t.video&&t.video.getIframe(function(e){var i=e.parentNode;t.css(e,{position:"fixed",top:"0px",left:"0px",right:"0px",bottom:"0px",width:"100%",height:"100%",maxWidth:"none",maxHeight:"none",visibility:"visible",margin:0,zIndex:-1}),t.$video=e,t.image.$container.appendChild(e),i.parentNode.removeChild(i)})};var i=t.prototype.coverImage;t.prototype.coverImage=function(){var t=this;i.apply(t),t.video&&"IFRAME"===t.image.$item.nodeName&&t.css(t.image.$item,{height:t.image.$item.getBoundingClientRect().height+400+"px",marginTop:-200+parseFloat(t.css(t.image.$item,"margin-top"))+"px"})};var n=t.prototype.initImg;t.prototype.initImg=function(){var t=this,e=n.apply(t);if(t.options.videoSrc||(t.options.videoSrc=t.$item.getAttribute("data-jarallax-video")||!1),t.options.videoSrc){var i=new VideoWorker(t.options.videoSrc,{startTime:t.options.videoStartTime||0,endTime:t.options.videoEndTime||0});if(i.isValid()&&(t.image.useImgTag=!0,i.on("ready",function(){var e=t.onScroll;t.onScroll=function(){e.apply(t),t.isVisible()?i.play():i.pause()}}),i.on("started",function(){t.image.$default_item=t.image.$item,t.image.$item=t.$video,t.image.width=t.options.imgWidth=t.video.videoWidth||1280,t.image.height=t.options.imgHeight=t.video.videoHeight||720,t.coverImage(),t.clipContainer(),t.onScroll(),t.image.$default_item&&(t.image.$default_item.style.display="none")}),t.video=i,"local"!==i.type&&i.getImageURL(function(e){t.image.src=e,t.init()})),"local"!==i.type)return!1;if(!e)return t.image.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",!0}return e};var o=t.prototype.destroy;t.prototype.destroy=function(){var t=this;o.apply(t)}}}(),!function(){function t(){z.keyboardSupport&&p("keydown",s)}function e(){if(!$&&document.body){$=!0;var e=document.body,i=document.documentElement,n=window.innerHeight,o=e.scrollHeight;if(j=document.compatMode.indexOf("CSS")>=0?i:e,I=e,t(),top!=self)P=!0;else if(et&&o>n&&(e.offsetHeight<=n||i.offsetHeight<=n)){var s=document.createElement("div");s.style.cssText="position:absolute; z-index:-10000; top:0; left:0; right:0; height:"+j.scrollHeight+"px",document.body.appendChild(s);var a;T=function(){a||(a=setTimeout(function(){M||(s.style.height="0",s.style.height=j.scrollHeight+"px",a=null)},500))},setTimeout(T,10),p("resize",T);var r={attributes:!0,childList:!0,characterData:!1};if(k=new U(T),k.observe(e,r),j.offsetHeight<=n){var l=document.createElement("div");l.style.clear="both",e.appendChild(l)}}z.fixedBackground||M||(e.style.backgroundAttachment="scroll",i.style.backgroundAttachment="scroll")}}function i(){k&&k.disconnect(),f(V,o),f("mousedown",a),f("keydown",s),f("resize",T),f("load",e)}function n(t,e,i){if(g(e,i),1!=z.accelerationMax){var n=Date.now(),o=n-R;if(o<z.accelerationDelta){var s=(1+50/o)/2;s>1&&(s=Math.min(s,z.accelerationMax),e*=s,i*=s)}R=Date.now()}if(W.push({x:e,y:i,lastX:e<0?.99:-.99,lastY:i<0?.99:-.99,start:Date.now()}),!H){var a=t===document.body,r=function(n){for(var o=Date.now(),s=0,l=0,c=0;c<W.length;c++){var u=W[c],d=o-u.start,h=d>=z.animationTime,p=h?1:d/z.animationTime;z.pulseAlgorithm&&(p=x(p));var f=u.x*p-u.lastX>>0,m=u.y*p-u.lastY>>0;s+=f,l+=m,u.lastX+=f,u.lastY+=m,h&&(W.splice(c,1),c--)}a?window.scrollBy(s,l):(s&&(t.scrollLeft+=s),l&&(t.scrollTop+=l)),e||i||(W=[]),W.length?Y(r,t,1e3/z.frameRate+1):H=!1};Y(r,t,0),H=!0}}function o(t){$||e();var i=t.target;if(t.defaultPrevented||t.ctrlKey)return!0;if(m(I,"embed")||m(i,"embed")&&/\.pdf/i.test(i.src)||m(I,"object")||i.shadowRoot)return!0;var o=-t.wheelDeltaX||t.deltaX||0,s=-t.wheelDeltaY||t.deltaY||0;D&&(t.wheelDeltaX&&y(t.wheelDeltaX,120)&&(o=-120*(t.wheelDeltaX/Math.abs(t.wheelDeltaX))),t.wheelDeltaY&&y(t.wheelDeltaY,120)&&(s=-120*(t.wheelDeltaY/Math.abs(t.wheelDeltaY)))),o||s||(s=-t.wheelDelta||0),1===t.deltaMode&&(o*=40,s*=40);var a=c(i);return a?!!v(s)||(Math.abs(o)>1.2&&(o*=z.stepSize/120),Math.abs(s)>1.2&&(s*=z.stepSize/120),n(a,o,s),t.preventDefault(),void r()):!P||!G||(Object.defineProperty(t,"target",{value:window.frameElement}),parent.wheel(t))}function s(t){var e=t.target,i=t.ctrlKey||t.altKey||t.metaKey||t.shiftKey&&t.keyCode!==B.spacebar;document.body.contains(I)||(I=document.activeElement);var o=/^(textarea|select|embed|object)$/i,s=/^(button|submit|radio|checkbox|file|color|image)$/i;if(t.defaultPrevented||o.test(e.nodeName)||m(e,"input")&&!s.test(e.type)||m(I,"video")||b(t)||e.isContentEditable||i)return!0;if((m(e,"button")||m(e,"input")&&s.test(e.type))&&t.keyCode===B.spacebar)return!0;if(m(e,"input")&&"radio"==e.type&&N[t.keyCode])return!0;var a,l=0,u=0,d=c(I);if(!d)return!P||!G||parent.keydown(t);var h=d.clientHeight;switch(d==document.body&&(h=window.innerHeight),t.keyCode){case B.up:u=-z.arrowScroll;break;case B.down:u=z.arrowScroll;break;case B.spacebar:a=t.shiftKey?1:-1,u=-a*h*.9;break;case B.pageup:u=.9*-h;break;case B.pagedown:u=.9*h;break;case B.home:u=-d.scrollTop;break;case B.end:var p=d.scrollHeight-d.scrollTop,f=p-h;u=f>0?f+10:0;break;case B.left:l=-z.arrowScroll;break;case B.right:l=z.arrowScroll;break;default:return!0}n(d,l,u),t.preventDefault(),r()}function a(t){I=t.target}function r(){clearTimeout(E),E=setInterval(function(){F={}},1e3)}function l(t,e){for(var i=t.length;i--;)F[q(t[i])]=e;return e}function c(t){var e=[],i=document.body,n=j.scrollHeight;do{var o=F[q(t)];if(o)return l(e,o);if(e.push(t),n===t.scrollHeight){var s=d(j)&&d(i),a=s||h(j);if(P&&u(j)||!P&&a)return l(e,Q())}else if(u(t)&&h(t))return l(e,t)}while(t=t.parentElement)}function u(t){return t.clientHeight+10<t.scrollHeight}function d(t){var e=getComputedStyle(t,"").getPropertyValue("overflow-y");return"hidden"!==e}function h(t){var e=getComputedStyle(t,"").getPropertyValue("overflow-y");return"scroll"===e||"auto"===e}function p(t,e){window.addEventListener(t,e,!1)}function f(t,e){window.removeEventListener(t,e,!1)}function m(t,e){return(t.nodeName||"").toLowerCase()===e.toLowerCase()}function g(t,e){t=t>0?1:-1,e=e>0?1:-1,A.x===t&&A.y===e||(A.x=t,A.y=e,W=[],R=0)}function v(t){if(t)return O.length||(O=[t,t,t]),t=Math.abs(t),O.push(t),O.shift(),clearTimeout(S),S=setTimeout(function(){try{localStorage.SS_deltaBuffer=O.join(",")}catch(t){}},1e3),!w(120)&&!w(100)}function y(t,e){return Math.floor(t/e)==t/e}function w(t){return y(O[0],t)&&y(O[1],t)&&y(O[2],t)}function b(t){var e=t.target,i=!1;if(document.URL.indexOf("www.youtube.com/watch")!=-1)do if(i=e.classList&&e.classList.contains("html5-video-controls"))break;while(e=e.parentNode);return i}function _(t){var e,i,n;return t*=z.pulseScale,t<1?e=t-(1-Math.exp(-t)):(i=Math.exp(-1),t-=1,n=1-Math.exp(-t),e=i+n*(1-i)),e*z.pulseNormalize}function x(t){return t>=1?1:t<=0?0:(1==z.pulseNormalize&&(z.pulseNormalize/=_(1)),_(t))}function C(t){for(var e in t)L.hasOwnProperty(e)&&(z[e]=t[e])}var I,k,T,E,S,L={frameRate:150,animationTime:400,stepSize:100,pulseAlgorithm:!0,pulseScale:4,pulseNormalize:1,accelerationDelta:50,accelerationMax:3,keyboardSupport:!0,arrowScroll:50,fixedBackground:!0,excluded:""},z=L,M=!1,P=!1,A={x:0,y:0},$=!1,j=document.documentElement,O=[],D=/^Mac/.test(navigator.platform),B={left:37,up:38,right:39,down:40,spacebar:32,pageup:33,pagedown:34,end:35,home:36},N={37:1,38:1,39:1,40:1},W=[],H=!1,R=Date.now(),q=function(){var t=0;return function(e){return e.uniqueID||(e.uniqueID=t++)}}(),F={};if(window.localStorage&&localStorage.SS_deltaBuffer)try{O=localStorage.SS_deltaBuffer.split(",")}catch(t){}var V,Y=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(t,e,i){window.setTimeout(t,i||1e3/60)}}(),U=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver,Q=function(){var t;return function(){if(!t){var e=document.createElement("div");e.style.cssText="height:10000px;width:1px;",document.body.appendChild(e);var i=document.body.scrollTop;document.documentElement.scrollTop,window.scrollBy(0,3),t=document.body.scrollTop!=i?document.body:document.documentElement,window.scrollBy(0,-3),document.body.removeChild(e)}return t}}(),Z=window.navigator.userAgent,X=/Edge/.test(Z),G=/chrome/i.test(Z)&&!X,K=/safari/i.test(Z)&&!X,J=/mobile/i.test(Z),tt=/Windows NT 6.1/i.test(Z)&&/rv:11/i.test(Z),et=K&&(/Version\/8/i.test(Z)||/Version\/9/i.test(Z)),it=(G||K||tt)&&!J;"onwheel"in document.createElement("div")?V="wheel":"onmousewheel"in document.createElement("div")&&(V="mousewheel"),V&&it&&(p(V,o),p("mousedown",a),p("load",e)),C.destroy=i,window.SmoothScrollOptions&&C(window.SmoothScrollOptions),"function"==typeof define&&define.amd?define(function(){return C}):"object"==typeof exports?module.exports=C:window.SmoothScroll=C}(),/*!
